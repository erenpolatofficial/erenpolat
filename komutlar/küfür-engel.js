...
exports.run = async(client, message, args) => {
  ...
  if (!args[0]) return message.channel.send(`:no_entry: Küfür Filtresini ayarlamak İçin \`/küfür aç\` | kapatmak istiyorsanız \`+küfür kapat\` yazabilirsiniz`)
  ...
  message.channel.send(`Küfür Filtresi başarıyla aktif edildi.`)    
  ...
  if (args[0] == 'kapat') {
    ...
    message.channel.send(`Küfür Filtresini başarıyla kapatıldı.`)
  }
